...
export type IndividualAccrual = Tables<'individual_accruals'>;
...
export type IndividualAccrualInsert = Inserts<'individual_accruals'>;
export type IndividualAccrualUpdate = Updates<'individual_accruals'>;
