...
export function BenefitCard({ benefit, onAddToCart }: BenefitCardProps) {
  ...
  return (
    <div className={`group relative flex h-full flex-col rounded-xl border bg-card transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 ${benefit.recommendation_reason ? "border-primary/30 shadow-[0_0_0_1px_hsl(252_85%_58%/0.08)]" : ""}`}>
      {benefit.recommendation_reason && (
        <div className="rounded-t-xl bg-gradient-to-r from-[hsl(252,85%,64%)] to-[hsl(275,75%,48%)] px-5 py-2 flex items-center gap-1.5 text-xs text-white">
