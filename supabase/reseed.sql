...
DELETE FROM reviews WHERE tenant_id = '00000000-0000-4000-8000-000000000001';
DELETE FROM tenant_offerings WHERE tenant_id = '00000000-0000-4000-8000-000000000001';
DELETE FROM provider_offerings WHERE provider_id IN (SELECT id FROM providers WHERE id IN (
...
INSERT INTO tenant_offerings (id, tenant_id, provider_offering_id, custom_price_points, is_active, enabled_by) VALUES
    ('00000000-0000-4000-8000-000000000800',
     '00000000-0000-4000-8000-000000000001',
     '00000000-0000-4000-8000-000000000700',
     20000, true, '00000000-0000-4000-8000-000000000020'),

    ('00000000-0000-4000-8000-000000000801',
     '00000000-0000-4000-8000-000000000001',
     '00000000-0000-4000-8000-000000000701',
     NULL, true, '00000000-0000-4000-8000-000000000020'),

    ('00000000-0000-4000-8000-000000000802',
     '00000000-0000-4000-8000-000000000001',
     '00000000-0000-4000-8000-000000000702',
     4500, true, '00000000-0000-4000-8000-000000000020'),

    ('00000000-0000-4000-8000-000000000803',
     '00000000-0000-4000-8000-000000000001',
     '00000000-0000-4000-8000-000000000703',
     25000, true, '00000000-0000-4000-8000-000000000020'),
    ...
    ('00000000-0000-4000-8000-000000000807',
     '00000000-0000-4000-8000-000000000001',
     '00000000-0000-4000-8000-000000000707',
     18000, true, '00000000-0000-4000-8000-000000000020'),
    ...
    ('00000000-0000-4000-8000-00000000080a',
     '00000000-0000-4000-8000-000000000001',
     '00000000-0000-4000-8000-00000000070a',
     5500, true, '00000000-0000-4000-8000-000000000020'),

    ('00000000-0000-4000-8000-00000000080b',
     '00000000-0000-4000-8000-000000000001',
     '00000000-0000-4000-8000-00000000070b',
     32000, true, '00000000-0000-4000-8000-000000000020'),
